#!/usr/bin/env python3
"""
SenterOS TUI Interface
=======================

A simple but powerful terminal user interface for SenterOS v3.0.
...
class SenterOSTUI(App):
    """SenterOS Terminal User Interface."""
...
def run_cli():
    ...
    print("\n" + "=" * 60)
    print("   SenterOS v3.0 - Configuration-Driven AI Assistant")
    print("=" * 60)
    print("\nType 'quit' to exit.\n")
